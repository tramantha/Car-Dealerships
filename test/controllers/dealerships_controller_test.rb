...
class DealershipsControllerTest < ActionController::TestCase
  ...
  test "should create dealership" do
    assert_difference('Dealership.count') do
      post :create, dealership: { address: @dealership.address, city: @dealership.city, name: @dealership.name, owner: @dealership.owner, state: @dealership.state, zip: @dealership.zip }
    end
  ...
  test "should update dealership" do
    patch :update, id: @dealership, dealership: { address: @dealership.address, city: @dealership.city, name: @dealership.name, owner: @dealership.owner, state: @dealership.state, zip: @dealership.zip }
    assert_redirected_to dealership_path(assigns(:dealership))
  end
